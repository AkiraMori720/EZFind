...
export default class AppHeader extends Component {
    ...
    render() {
        ...
        return (
            ...
            <SafeAreaView style={[styles.container, { backgroundColor: this.props.bgColor || colors.AppRedColor }]}>
                <TouchableOpacity style={styles.headerProfile} onPress={this.props.onLeftIconPress}>
                    ...
                    {this.props.leftIconPath !== undefined &&
                        <Image resizeMode="contain" style={[styles.img, this.props.lefticonSize
                            !== undefined ? { height: this.props.lefticonSize, width: this.props.lefticonSize } : { height: 20, width: 20, tintColor: this.props.tintColor || colors.appYellow }]}
                ...
                <View style={styles.headerMenu} >
                    <TouchableOpacity style={[styles.headerMenu, { marginLeft: wp(7) }]} onPress={this.props.onRightIconTwoPress}>
                        {this.props.rightIconTwoPath !== undefined &&
                            <Image resizeMode="contain" style={[styles.img, this.props.rightIconSize !== undefined ? { height: this.props.rightIconSize, width: this.props.rightIconSize } : { height: 23, width: 23, tintColor: this.props.tintColor || colors.white }]}
                    ...
                    <TouchableOpacity onPress={this.props.onRightIconPress}>
                        {this.props.rightIconOnePath !== undefined &&
                            <Image resizeMode="contain" style={[this.props.rightIconSize !== undefined ? { height: this.props.rightIconSize, width: this.props.rightIconSize } : { height: 23, width: 23 }]}
                                source={this.props.rightIconOnePath} />
                        }
                        {this.props.rightText !== undefined ?
                            <Text style={styles.text}>{this.props.rightText}</Text> : null
                        }
                    </TouchableOpacity>
                </View>
